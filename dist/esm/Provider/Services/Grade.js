...
class Grade {
  ...
  async getLineItems(idtoken, options, accessToken) {
    ...
    if (!accessToken) {
      const platform = await _classPrivateFieldLooseBase(this, _getPlatform)[_getPlatform](idtoken.iss, idtoken.clientId, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY)[_ENCRYPTIONKEY], _classPrivateFieldLooseBase(this, _Database)[_Database]); // Remove and use DB instead
