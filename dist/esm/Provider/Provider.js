 ...
 */
var _loginRoute = /*#__PURE__*/_classPrivateFieldLooseKey("loginRoute");
var _appRoute = /*#__PURE__*/_classPrivateFieldLooseKey("appRoute");
var _keysetRoute = /*#__PURE__*/_classPrivateFieldLooseKey("keysetRoute");
var _dynRegRoute = /*#__PURE__*/_classPrivateFieldLooseKey("dynRegRoute");
var _whitelistedRoutes = /*#__PURE__*/_classPrivateFieldLooseKey("whitelistedRoutes");
var _ENCRYPTIONKEY2 = /*#__PURE__*/_classPrivateFieldLooseKey("ENCRYPTIONKEY");
var _devMode = /*#__PURE__*/_classPrivateFieldLooseKey("devMode");
var _ltiaas = /*#__PURE__*/_classPrivateFieldLooseKey("ltiaas");
var _tokenMaxAge = /*#__PURE__*/_classPrivateFieldLooseKey("tokenMaxAge");
var _cookieOptions = /*#__PURE__*/_classPrivateFieldLooseKey("cookieOptions");
var _setup = /*#__PURE__*/_classPrivateFieldLooseKey("setup");
var _connectCallback2 = /*#__PURE__*/_classPrivateFieldLooseKey("connectCallback");
var _deepLinkingCallback2 = /*#__PURE__*/_classPrivateFieldLooseKey("deepLinkingCallback");
var _dynamicRegistrationCallback2 = /*#__PURE__*/_classPrivateFieldLooseKey("dynamicRegistrationCallback");
var _sessionTimeoutCallback2 = /*#__PURE__*/_classPrivateFieldLooseKey("sessionTimeoutCallback");
var _invalidTokenCallback2 = /*#__PURE__*/_classPrivateFieldLooseKey("invalidTokenCallback");
var _unregisteredPlatformCallback2 = /*#__PURE__*/_classPrivateFieldLooseKey("unregisteredPlatformCallback");
var _inactivePlatformCallback2 = /*#__PURE__*/_classPrivateFieldLooseKey("inactivePlatformCallback");
var _keyset = /*#__PURE__*/_classPrivateFieldLooseKey("keyset");
var _server = /*#__PURE__*/_classPrivateFieldLooseKey("server");
class Provider {
  constructor() {
    // Pre-initiated variables
    Object.defineProperty(this, _loginRoute, {
      writable: true,
      value: '/login'
    });
    Object.defineProperty(this, _appRoute, {
      writable: true,
      value: '/'
    });
    Object.defineProperty(this, _keysetRoute, {
      writable: true,
      value: '/keys'
    });
    Object.defineProperty(this, _dynRegRoute, {
      writable: true,
      value: '/register'
    });
    Object.defineProperty(this, _whitelistedRoutes, {
      writable: true,
      value: []
    });
    ...
    Object.defineProperty(this, _devMode, {
      writable: true,
      value: false
    });
    Object.defineProperty(this, _ltiaas, {
      writable: true,
      value: false
    });
    Object.defineProperty(this, _tokenMaxAge, {
      writable: true,
      value: 10
    });
    ...
    Object.defineProperty(this, _deepLinkingCallback2, {
      writable: true,
      value: async (token, req, res, next) => {
        return next();
      }
    });
    Object.defineProperty(this, _dynamicRegistrationCallback2, {
      writable: true,
    ...
    Object.defineProperty(this, _sessionTimeoutCallback2, {
      writable: true,
      value: async (req, res) => {
        return res.status(401).send(res.locals.err);
      }
    });
    Object.defineProperty(this, _invalidTokenCallback2, {
      writable: true,
      value: async (req, res) => {
        return res.status(401).send(res.locals.err);
      }
    });
    Object.defineProperty(this, _unregisteredPlatformCallback2, {
      writable: true,
      value: async (req, res) => {
    ...
    Object.defineProperty(this, _inactivePlatformCallback2, {
      writable: true,
      value: async (req, res) => {
    ...
    Object.defineProperty(this, _keyset, {
      ...
      value: async (req, res) => {
        try {
          const keyset = await Keyset.build(this.Database, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2]);
  ...
  setup(encryptionkey, database, options) {
    if (_classPrivateFieldLooseBase(this, _setup)[_setup]) throw new Error('PROVIDER_ALREADY_SETUP');
    ...
    if (options && (options.appRoute || options.appUrl)) _classPrivateFieldLooseBase(this, _appRoute)[_appRoute] = options.appRoute || options.appUrl;
    if (options && (options.loginRoute || options.loginUrl)) _classPrivateFieldLooseBase(this, _loginRoute)[_loginRoute] = options.loginRoute || options.loginUrl;
    if (options && (options.keysetRoute || options.keysetUrl)) _classPrivateFieldLooseBase(this, _keysetRoute)[_keysetRoute] = options.keysetRoute || options.keysetUrl;
    if (options && options.dynRegRoute) _classPrivateFieldLooseBase(this, _dynRegRoute)[_dynRegRoute] = options.dynRegRoute;
    if (options && options.devMode === true) _classPrivateFieldLooseBase(this, _devMode)[_devMode] = true;
    if (options && options.ltiaas === true) _classPrivateFieldLooseBase(this, _ltiaas)[_ltiaas] = true;
    if (options && options.tokenMaxAge !== undefined) _classPrivateFieldLooseBase(this, _tokenMaxAge)[_tokenMaxAge] = options.tokenMaxAge;

    // Cookie options
    if (options && options.cookies) {
      if (options.cookies.secure === true) _classPrivateFieldLooseBase(this, _cookieOptions)[_cookieOptions].secure = true;
      if (options.cookies.sameSite) _classPrivateFieldLooseBase(this, _cookieOptions)[_cookieOptions].sameSite = options.cookies.sameSite;
      if (options.cookies.domain) _classPrivateFieldLooseBase(this, _cookieOptions)[_cookieOptions].domain = options.cookies.domain;
    }
    _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2] = encryptionkey;
    _classPrivateFieldLooseBase(this, _server)[_server] = new Server(options ? options.https : false, options ? options.ssl : false, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2], options ? options.cors : true, options ? options.serverAddon : false);
     ...
     */
    this.Grade = new GradeService(this.getPlatform, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2], this.Database);

    /**
     * @description Deep Linking service.
     */
    this.DeepLinking = new DeepLinkingService(this.getPlatform, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2], this.Database);

    /**
     * @description Names and Roles service.
     */
    this.NamesAndRoles = new NamesAndRolesService(this.getPlatform, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2], this.Database);
    if (options && options.dynReg) {
      const routes = {
        appRoute: _classPrivateFieldLooseBase(this, _appRoute)[_appRoute],
        loginRoute: _classPrivateFieldLooseBase(this, _loginRoute)[_loginRoute],
        keysetRoute: _classPrivateFieldLooseBase(this, _keysetRoute)[_keysetRoute]
      };
      /**
       * @description Dynamic Registration service.
       */
      this.DynamicRegistration = new DynamicRegistration(options.dynReg, routes, this.registerPlatform, this.getPlatform, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2], this.Database);
    }
    if (options && options.staticPath) _classPrivateFieldLooseBase(this, _server)[_server].setStaticPath(options.staticPath);
    ...
    const sessionValidator = async (req, res, next) => {
      ...
      if (req.path === _classPrivateFieldLooseBase(this, _loginRoute)[_loginRoute] || req.path === _classPrivateFieldLooseBase(this, _keysetRoute)[_keysetRoute] || req.path === _classPrivateFieldLooseBase(this, _dynRegRoute)[_dynRegRoute]) return next();
      ...
      try {
        ...
        if (!ltik) {
          ...
          if (idtoken) {
            ...
            const validationParameters = {
              ...
              maxAge: _classPrivateFieldLooseBase(this, _tokenMaxAge)[_tokenMaxAge]
            };
            const valid = await Auth.validateToken(idtoken, _classPrivateFieldLooseBase(this, _devMode)[_devMode], validationParameters, this.getPlatform, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2], this.Database);
            ...
            res.clearCookie('state' + state, _classPrivateFieldLooseBase(this, _cookieOptions)[_cookieOptions]);
            ...
            if (!_classPrivateFieldLooseBase(this, _ltiaas)[_ltiaas]) res.cookie(platformCode, valid.sub, _classPrivateFieldLooseBase(this, _cookieOptions)[_cookieOptions]);
            ...
            const newLtik = jwt.sign(newLtikObj, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2]);
            if (_classPrivateFieldLooseBase(this, _ltiaas)[_ltiaas]) {
            ...
            if (_classPrivateFieldLooseBase(this, _whitelistedRoutes)[_whitelistedRoutes].find(r => {
            ...
            return _classPrivateFieldLooseBase(this, _invalidTokenCallback2)[_invalidTokenCallback2](req, res, next);
          }
        }
        provMainDebug('Ltik found');
        let validLtik;
        try {
          validLtik = jwt.verify(ltik, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2]);
        } catch (err) {
          if (_classPrivateFieldLooseBase(this, _whitelistedRoutes)[_whitelistedRoutes].find(r => {
            if (r.route instanceof RegExp && r.route.test(req.path) || r.route === req.path) return r.method === 'ALL' || r.method === req.method.toUpperCase();
            return false;
        ...
        if (!_classPrivateFieldLooseBase(this, _ltiaas)[_ltiaas]) {
          ...
          if (!cookieUser) {
            if (!_classPrivateFieldLooseBase(this, _devMode)[_devMode]) user = false;else {
        ...
        if (user) {
          ...
          return _classPrivateFieldLooseBase(this, _sessionTimeoutCallback2)[_sessionTimeoutCallback2](req, res, next);
        }
      } catch (err) {
        const state = req.body.state;
        if (state) {
    ...
    this.app.all(_classPrivateFieldLooseBase(this, _loginRoute)[_loginRoute], async (req, res) => {
      const params = {
        ...req.query,
        ...req.body
      };
      try {
        ...
        if (platform) {
          ...
          if (!platformActive) return _classPrivateFieldLooseBase(this, _inactivePlatformCallback2)[_inactivePlatformCallback2](req, res);
          ...
          const cookieOptions = JSON.parse(JSON.stringify(_classPrivateFieldLooseBase(this, _cookieOptions)[_cookieOptions]));
          ...
          return _classPrivateFieldLooseBase(this, _unregisteredPlatformCallback2)[_unregisteredPlatformCallback2](req, res);
        }
      } catch (err) {
        provMainDebug(err);
        return res.status(500).send({
    ...
    this.app.get(_classPrivateFieldLooseBase(this, _keysetRoute)[_keysetRoute], async (req, res, next) => {
      return _classPrivateFieldLooseBase(this, _keyset)[_keyset](req, res, next);
    });
    this.app.all(_classPrivateFieldLooseBase(this, _dynRegRoute)[_dynRegRoute], async (req, res, next) => {
      if (this.DynamicRegistration) return _classPrivateFieldLooseBase(this, _dynamicRegistrationCallback2)[_dynamicRegistrationCallback2](req, res, next);
    ...
    // Main app
    this.app.all(_classPrivateFieldLooseBase(this, _appRoute)[_appRoute], async (req, res, next) => {
      if (res.locals.context && res.locals.context.messageType === 'LtiDeepLinkingRequest') return _classPrivateFieldLooseBase(this, _deepLinkingCallback2)[_deepLinkingCallback2](res.locals.token, req, res, next);
      return _classPrivateFieldLooseBase(this, _connectCallback2)[_connectCallback2](res.locals.token, req, res, next);
    });
    _classPrivateFieldLooseBase(this, _setup)[_setup] = true;
    return this;
  }
  ...
  async deploy(options) {
    if (!_classPrivateFieldLooseBase(this, _setup)[_setup]) throw new Error('PROVIDER_NOT_SETUP');
    ...
    try {
      ...
      if (options && options.serverless) {
        ...
        await _classPrivateFieldLooseBase(this, _server)[_server].listen(conf.port);
        provMainDebug('Ltijs started listening on port: ', conf.port);

        // Startup message
        const message = 'LTI Provider is listening on port ' + conf.port + '!\n\n LTI provider config: \n >App Route: ' + _classPrivateFieldLooseBase(this, _appRoute)[_appRoute] + '\n >Initiate Login Route: ' + _classPrivateFieldLooseBase(this, _loginRoute)[_loginRoute] + '\n >Keyset Route: ' + _classPrivateFieldLooseBase(this, _keysetRoute)[_keysetRoute] + '\n >Dynamic Registration Route: ' + _classPrivateFieldLooseBase(this, _dynRegRoute)[_dynRegRoute];
        if (!conf.silent) {
          console.log('  _   _______ _____      _  _____\n' + ' | | |__   __|_   _|    | |/ ____|\n' + ' | |    | |    | |      | | (___  \n' + ' | |    | |    | |  _   | |\\___ \\ \n' + ' | |____| |   _| |_| |__| |____) |\n' + ' |______|_|  |_____|\\____/|_____/ \n\n', message);
        }
      }
      if (_classPrivateFieldLooseBase(this, _devMode)[_devMode] && !conf.silent) console.log('\nStarting in Dev Mode, state validation and session cookies will not be required. THIS SHOULD NOT BE USED IN A PRODUCTION ENVIRONMENT!');
  ...
  async close(options) {
    ...
    await _classPrivateFieldLooseBase(this, _server)[_server].close();
  ...
  onConnect(_connectCallback, options) {
    ...
    if (options) {
      ...
      if (options.sameSite) {
        _classPrivateFieldLooseBase(this, _cookieOptions)[_cookieOptions].sameSite = options.sameSite;
        if (options.sameSite.toLowerCase() === 'none') _classPrivateFieldLooseBase(this, _cookieOptions)[_cookieOptions].secure = true;
      }
      if (options.secure === true) _classPrivateFieldLooseBase(this, _cookieOptions)[_cookieOptions].secure = true;
      if (options.sessionTimeout) _classPrivateFieldLooseBase(this, _sessionTimeoutCallback2)[_sessionTimeoutCallback2] = options.sessionTimeout;
      if (options.invalidToken) _classPrivateFieldLooseBase(this, _invalidTokenCallback2)[_invalidTokenCallback2] = options.invalidToken;
    }
    if (_connectCallback) {
  ...
  onDeepLinking(_deepLinkingCallback) {
    if (_deepLinkingCallback) {
      _classPrivateFieldLooseBase(this, _deepLinkingCallback2)[_deepLinkingCallback2] = _deepLinkingCallback;
      return true;
    }
    throw new Error('MISSING_CALLBACK');
  }
  ...
  onDynamicRegistration(_dynamicRegistrationCallback) {
    if (_dynamicRegistrationCallback) {
      _classPrivateFieldLooseBase(this, _dynamicRegistrationCallback2)[_dynamicRegistrationCallback2] = _dynamicRegistrationCallback;
      return true;
    }
    throw new Error('MISSING_CALLBACK');
  }
  ...
  onSessionTimeout(_sessionTimeoutCallback) {
    if (_sessionTimeoutCallback) {
      _classPrivateFieldLooseBase(this, _sessionTimeoutCallback2)[_sessionTimeoutCallback2] = _sessionTimeoutCallback;
      return true;
    }
    throw new Error('MISSING_CALLBACK');
  }
  ...
  onInvalidToken(_invalidTokenCallback) {
    if (_invalidTokenCallback) {
      _classPrivateFieldLooseBase(this, _invalidTokenCallback2)[_invalidTokenCallback2] = _invalidTokenCallback;
      return true;
    }
    throw new Error('MISSING_CALLBACK');
  }
  ...
  onUnregisteredPlatform(_unregisteredPlatformCallback) {
    if (_unregisteredPlatformCallback) {
      _classPrivateFieldLooseBase(this, _unregisteredPlatformCallback2)[_unregisteredPlatformCallback2] = _unregisteredPlatformCallback;
      return true;
    }
    throw new Error('MISSING_CALLBACK');
  }
  ...
  onInactivePlatform(_inactivePlatformCallback) {
    if (_inactivePlatformCallback) {
      _classPrivateFieldLooseBase(this, _inactivePlatformCallback2)[_inactivePlatformCallback2] = _inactivePlatformCallback;
      return true;
    }
    throw new Error('MISSING_CALLBACK');
  }
   ...
   */
  appRoute() {
    return _classPrivateFieldLooseBase(this, _appRoute)[_appRoute];
  }
   ...
   */
  loginRoute() {
    return _classPrivateFieldLooseBase(this, _loginRoute)[_loginRoute];
  }
  ...
  /**
     ...
     */
  keysetRoute() {
    return _classPrivateFieldLooseBase(this, _keysetRoute)[_keysetRoute];
  }
   ...
   */
  dynRegRoute() {
    return _classPrivateFieldLooseBase(this, _dynRegRoute)[_dynRegRoute];
  }
   ...
   */
  whitelist(...routes) {
    if (!routes) return _classPrivateFieldLooseBase(this, _whitelistedRoutes)[_whitelistedRoutes];
    ...
    _classPrivateFieldLooseBase(this, _whitelistedRoutes)[_whitelistedRoutes] = [..._classPrivateFieldLooseBase(this, _whitelistedRoutes)[_whitelistedRoutes], ...formattedRoutes];
    return _classPrivateFieldLooseBase(this, _whitelistedRoutes)[_whitelistedRoutes];
  }
  ...
  async registerPlatform(platform, getPlatform, ENCRYPTIONKEY, Database) {
    ...
    const _ENCRYPTIONKEY = ENCRYPTIONKEY || _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2];
  ...
  async getPlatformById(platformId) {
    ...
    if (!result) return false;
    const plat = result[0];
    const platform = new Platform(plat.platformName, plat.platformUrl, plat.clientId, plat.authEndpoint, plat.accesstokenEndpoint, plat.authorizationServer, plat.kid, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2], plat.authConfig, this.Database);
    return platform;
  }
  ...
  async updatePlatformById(platformId, platformInfo) {
    ...
    try {
      ...
      const platform = new Platform(update.name, update.url, update.clientId, update.authenticationEndpoint, update.accesstokenEndpoint, update.authorizationServer, platformId, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2], update.authConfig, this.Database);
      return platform;
    } catch (err) {
      if (alteredUrlClientIdFlag) {
        await this.Database.Modify(false, 'publickey', {
  ...
  async getAllPlatforms() {
    ...
    const result = await this.Database.Get(false, 'platform');
    if (result) {
      for (const plat of result) platforms.push(new Platform(plat.platformName, plat.platformUrl, plat.clientId, plat.authEndpoint, plat.accesstokenEndpoint, plat.authorizationServer, plat.kid, _classPrivateFieldLooseBase(this, _ENCRYPTIONKEY2)[_ENCRYPTIONKEY2], plat.authConfig, this.Database));
      return platforms;
    }
    return [];
  }
