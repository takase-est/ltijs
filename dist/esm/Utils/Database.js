 ...
 */
var _dbUrl = /*#__PURE__*/_classPrivateFieldLooseKey("dbUrl");
var _dbConnection = /*#__PURE__*/_classPrivateFieldLooseKey("dbConnection");
...
class Database {
  ...
  constructor(database) {
    Object.defineProperty(this, _dbUrl, {
      writable: true,
      value: void 0
    });
    ...
    _classPrivateFieldLooseBase(this, _dbUrl)[_dbUrl] = database.url;
    if (database.debug) mongoose.set('debug', true);
    _classPrivateFieldLooseBase(this, _dbConnection)[_dbConnection] = {
      ..._classPrivateFieldLooseBase(this, _dbConnection)[_dbConnection],
      ...database.connection
    };
  ...
  async setup() {
    ...
    this.db.on('disconnected', async () => {
      ...
      setTimeout(async () => {
        if (this.db.readyState === 0) {
          try {
            await mongoose.connect(_classPrivateFieldLooseBase(this, _dbUrl)[_dbUrl], _classPrivateFieldLooseBase(this, _dbConnection)[_dbConnection]);
          } catch (err) {
    ...
    if (this.db.readyState === 0) await mongoose.connect(_classPrivateFieldLooseBase(this, _dbUrl)[_dbUrl], _classPrivateFieldLooseBase(this, _dbConnection)[_dbConnection]);
    _classPrivateFieldLooseBase(this, _deploy)[_deploy] = true;
    return true;
  }
  ...
  async Close() {
    ...
    _classPrivateFieldLooseBase(this, _deploy)[_deploy] = false;
    return true;
  }
  ...
  async Get(ENCRYPTIONKEY, collection, query) {
    if (!_classPrivateFieldLooseBase(this, _deploy)[_deploy]) throw new Error('PROVIDER_NOT_DEPLOYED');
